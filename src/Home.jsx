      ...
      <main className="flex-grow relative z-10">
        <div className="pt-12 pb-16 px-4 text-center">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="mb-12">
            <h1 className="text-4xl md:text-6xl text-white mb-6 uppercase font-['Poppins'] font-normal tracking-[0.05em] leading-none">CLASSCODE</h1>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="max-w-4xl mx-auto bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2rem] p-3 flex flex-col md:flex-row items-center gap-2 shadow-[0_0_50px_rgba(0,0,0,0.3)]">
            ...
            <div className="flex-1 flex items-center px-6 py-4 w-full relative border-r border-white/10">
